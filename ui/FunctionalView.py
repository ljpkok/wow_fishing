...
class FunctionalView(QWidget):
    ...
    def init_config_input(self):
        ...
        self.functional_value_input_dict = {
            ...
            'enable_to_work_time': (QLabel('StartToWorkTime(s): '), QDoubleSpinBox(self), 1.0, 1.0, 3600.0, 1.0, 4),
            'rest_time': (QLabel('RestTime(s): '), QDoubleSpinBox(self), 1.0, 1.0, 3600.0, 1.0, 5),
            'float_coordinate_changed_threshold': (QLabel('Threshold(s): '), QDoubleSpinBox(self), 2500.0, 1.0, 3600.0, 1.0, 6),
            'cast_period': (QLabel('Cast Period(s): '), QDoubleSpinBox(self), 29.5, 1.0, 3600.0, 1.0, 7),
            ...
            'max_fishing_count': (QLabel('MaxFishingCount: '), QDoubleSpinBox(self), 10000, 0, 10000, 1, 10),
        }
